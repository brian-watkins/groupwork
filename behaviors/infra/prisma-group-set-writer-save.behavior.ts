    ...
    .script({
      ...
      perform: [
        step("save the updated group set", async (context) => {
          ...
          groupSets[0].groups[0] = testGroup(
            course.students[3],
            course.students[1],
            course.students[4],
          )
          groupSets[0].groups[1] = testGroup(
            course.students[0],
            course.students[2],
            course.students[5],
          )
      ...
      observe: [
        effect(
          "the group set name and groups are updated in the database",
          async (context) => {
            const course = await context.getCourseValue(
              testTeacher(1),
              testCourse(1),
                    ...
                    [
                      objectWithProperty(
                        ...
                        setWith([
                          objectWithProperty(
                            "id",
                            equalTo(course.students[3].id),
                          ),
                          objectWithProperty(
                            "id",
                            equalTo(course.students[1].id),
                          ),
                          objectWithProperty(
                            "id",
                            equalTo(course.students[4].id),
                          ),
                        ]),
                      ),
                      objectWithProperty(
                        ...
                        setWith([
                          objectWithProperty(
                            "id",
                            equalTo(course.students[0].id),
                          ),
                          objectWithProperty(
                            "id",
                            equalTo(course.students[2].id),
                          ),
                          objectWithProperty(
                            "id",
                            equalTo(course.students[5].id),
                          ),
                        ]),
                      ),
                    ],
